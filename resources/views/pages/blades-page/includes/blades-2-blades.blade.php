<section class="title" id="">
    <div class="title__wrapper">
        <p class="title__h2">Скандинавские клинки</p>
        <p class="title__p">
            Классические и традиционные скандинавские клинки Раффир.  
        </p>
    </div>
</section>
    ...
    <div class="blades__category">
            ...
            <div class="blades__data-left">
                <div class="blades__item-wrapper blades__item-wrapper--title">
                    <div class="blades__item">
                        <p class="texture__item-p">Клинок Рабек</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="blades__item">
                        ...
                        <div class="blades__description-wrapper">
                            ...
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Модель:</p>
                                <p class="blades__description blades__description--value">Рабек, дизайн: Дженс Рабек (англ. Jens Rahbek)</p>
                            </div>
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Длина:</p>
                                <p class="blades__description blades__description--value">75мм (от пяты - по обуху - до острия)</p>
                            </div>
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Толщина:</p>
                                <p class="blades__description blades__description--value">2,8мм</p>
                            </div>
                            <p class="blades__description blades__description--price">Стоимоть: {{ Illuminate\Support\Facades\DB::table('products')->where('product_blade_model', 'рабек')->value('product_price')}} руб.</p>
                        </div>
                    </div>
        ...
        <div class="blades__data">
            <div class="blades__data-left">
                <div class="blades__item-wrapper blades__item-wrapper--title">
                    <div class="blades__item">
                        <p class="texture__item-p">Клинок Миккельсен</p>
                    </div>
                </div>
            </div>
            <div class="blades__data-right">
                <div class="blades__item-wrapper blades__item-wrapper--blade">
                    <div class="blades__item">
                        ...
                        <div class="blades__description-wrapper">
                            ...
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Модель:</p>
                                <p class="blades__description blades__description--value">Миккельсен - дизайн: Дженс Миккельсен (англ. Jens Mikkelsen)</p>
                            </div>
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Длина:</p>
                                <p class="blades__description blades__description--value">85мм (от пяты - по обуху - до острия)</p>
                            </div>
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Толщина:</p>
                                <p class="blades__description blades__description--value">2,8мм</p>
                            </div>
                            <p class="blades__description blades__description--price">Стоимоть: {{ Illuminate\Support\Facades\DB::table('products')->where('product_blade_model', 'миккельсен')->value('product_price')}} руб.</p>
                        </div>
                    </div>
                </div>
            </div> 
        ...
        <div class="blades__data">
            <div class="blades__data-left">
                <div class="blades__item-wrapper blades__item-wrapper--title">
                    <div class="blades__item">
                        <p class="texture__item-p">Клинок Кофоед</p>
                    </div>
                </div>
            </div>
            <div class="blades__data-right">
                <div class="blades__item-wrapper blades__item-wrapper--blade">
                    <div class="blades__item">
                        ...
                        <div class="blades__description-wrapper">
                            ...
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Модель:</p>
                                <p class="blades__description blades__description--value">Кофоед - дизайн: Ким Кофоед (англ. Kim Kofoed)</p>
                            </div>
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Длина:</p>
                                <p class="blades__description blades__description--value">100мм (от пяты - по обуху - до острия)</p>
                            </div>
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Толщина:</p>
                                <p class="blades__description blades__description--value">4мм</p>
                            </div>
                            <p class="blades__description blades__description--price">Стоимоть: {{ Illuminate\Support\Facades\DB::table('products')->where('product_blade_model', 'кофоед')->value('product_price')}} руб.</p>
                        </div>
                    </div>
                </div>
            </div> 
        ...
        <div class="blades__data">
            <div class="blades__data-left">
                <div class="blades__item-wrapper blades__item-wrapper--title">
                    <div class="blades__item">
                        <p class="texture__item-p">Клинок Астрап</p>
                    </div>
                </div>
            </div>
            <div class="blades__data-right">
                <div class="blades__item-wrapper blades__item-wrapper--blade">
                    <div class="blades__item">
                        ...
                        <div class="blades__description-wrapper">
                            ...
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Модель:</p>
                                <p class="blades__description blades__description--value">Астрап - дизайн: Томми Астрап (англ. Tommy Astrup)</p>
                            </div>
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Длина:</p>
                                <p class="blades__description blades__description--value">85мм (от пяты - по обуху - до острия)</p>
                            ...
                            <p class="blades__description blades__description--price">Стоимоть: {{ Illuminate\Support\Facades\DB::table('products')->where('product_blade_model', 'астрап')->value('product_price')}} руб.</p>
                        </div>
                    </div>
                </div>
            </div> 
        ...
        <div class="blades__data">
            <div class="blades__data-left">
                <div class="blades__item-wrapper blades__item-wrapper--title">
                    <div class="blades__item">
                        <p class="texture__item-p">Клинок Роде</p>
                    </div>
                </div>
            </div>
            <div class="blades__data-right">
                <div class="blades__item-wrapper blades__item-wrapper--blade">
                    <div class="blades__item">
                        ...
                        <div class="blades__description-wrapper">
                            ...
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Модель:</p>
                                <p class="blades__description blades__description--value">Роде - дизайн: Хеннинг Роде (англ. Henning Rohde)</p>
                            </div>
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Длина:</p>
                                <p class="blades__description blades__description--value">105мм (от пяты - по обуху - до острия)</p>
                            </div>
                            <div class="blades__description-row">
                                <p class="blades__description blades__description--title">Толщина:</p>
                                <p class="blades__description blades__description--value">4мм</p>
                            </div>
                            <p class="blades__description blades__description--price">Стоимоть: {{ Illuminate\Support\Facades\DB::table('products')->where('product_blade_model', 'роде')->value('product_price')}} руб.</p>
                        </div>
                    </div>
                </div>
            </div> 
...
<section class="title-gallery" id="">
    <div class="title-gallery__wrapper">
        ...
        <p class="title-gallery__p">Фотографии готовых ножей с клинками</p>
    </div>
</section>
...
<div class="gallery">
    ...
    <div class="gallery-item">
        <a data-fslightbox="first-lightbox" href="/images/gallery/blades/blade-1.jpg" alt="фотография Зуб мамонта - синий цвет">
            <div class="gallery-item-content">
                <img class="gallery-item-image" src="/images/gallery//blades/blade-1_thumb.jpg" alt="фотография Зуб мамонта - синий цвет превью">
            </div>
            <div class="gallery-item-description">
                <p class="gallery-item-description-text">Нож Дженса Миккельсена</p>
                <p class="gallery-item-description-text">клинок - Миккельсен</p>
            </div>
        </a>
    </div>
    ...
    <div class="gallery-item">
        <a data-fslightbox="first-lightbox" href="/images/gallery/blades/blade-2.jpg" alt="фотография Зуб мамонта - синий цвет">
            ...
            <div class="gallery-item-description">
                <p class="gallery-item-description-text">Нож Дженса Миккельсена (2)</p>
                <p class="gallery-item-description-text">клинок - Миккельсен</p>
            </div>
        </a>
    </div>
    ...
    <div class="gallery-item">
        <a data-fslightbox="first-lightbox" href="/images/gallery/blades/blade-3.jpg" alt="фотография Зуб мамонта - синий цвет">
            <div class="gallery-item-content">
                <img class="gallery-item-image" src="/images/gallery//blades/blade-3_thumb.jpg" alt="фотография Зуб мамонта - синий цвет превью">
            </div>
            <div class="gallery-item-description">
                <p class="gallery-item-description-text">Нож Томми Астрапа</p>
                <p class="gallery-item-description-text">клинок - Астрап</p>
            </div>
        </a>
    </div>

    <div class="gallery-item">
        <a data-fslightbox="first-lightbox" href="/images/gallery/blades/blade-4.jpg" alt="фотография Зуб мамонта - синий цвет">
            <div class="gallery-item-content">
                <img class="gallery-item-image" src="/images/gallery//blades/blade-4_thumb.jpg" alt="фотография Зуб мамонта - синий цвет превью">
            </div>
            <div class="gallery-item-description">
                <p class="gallery-item-description-text">Нож Томми Астрапа (2)</p>
                <p class="gallery-item-description-text">клинок - Астрап</p>
            </div>
        </a>
    </div>
