...
/***/ "./resources/js/admin-create-lot/createLot-setLotSizeTitle.js":
/*!********************************************************************!*\
  !*** ./resources/js/admin-create-lot/createLot-setLotSizeTitle.js ***!
  \********************************************************************/
/***/ (() => {
...
/***/ "./resources/js/admin-create-lot/createLot-weightCounter.js":
/*!******************************************************************!*\
  !*** ./resources/js/admin-create-lot/createLot-weightCounter.js ***!
  \******************************************************************/
/***/ (() => {
...
if (window.location.pathname == '/private/create') {
  var lotAnnotation = document.querySelector('.form-control-lot-annotation');
  var lotWeight = document.querySelector('.form-lot-weight');
  lotWeight.value = 30;
  var itemsWeight;
  var lotSizeTitle = document.querySelector('.form-control-lot-size-title');
  document.addEventListener('click', function (event) {
    var lotCount = document.querySelector('.form-control-lot-count');
    itemsWeight = document.querySelectorAll('.lot-create-data__input-weight');
    var counter = 0;
    itemsWeight.forEach(function (element) {
      counter += +element.value;
      lotWeight.value = counter; // console.log(lotWeight.value);
    ...
    lotCount.value = itemsWeight.length; //Auto generation of lot's annotation
    ...
    function lotAnnotationTemplate(lotSizeTitle, lotWeight, itemsCount) {
      return "This ".concat(lotSizeTitle, " ( a total weight of ").concat(lotWeight, " kilograms ) lot from Yakutia contains ").concat(itemsCount, ".");
    }

    var lotAnnotationString = lotAnnotationTemplate(lotSizeTitle.value, lotWeight.value, setItemORItems(lotCount.value));
    lotAnnotation.value = lotAnnotationString; // console.log(lotCount.value);
  });
}
...
/***/ "./resources/js/admin-create-lot/createLot.js":
/*!****************************************************!*\
  !*** ./resources/js/admin-create-lot/createLot.js ***!
  \****************************************************/
/***/ (() => {
...
if (window.location.pathname == '/private/create') {
  var btn = document.querySelector('.btn-addNewItem');
  var newItemWrapper = document.querySelector('.new-item-wrapper'); //то куда выводим таски

  var itemIndex = 2;
  var id = 100;

  var createTemplate = function createTemplate(itemIndex, id, index) {
    return "\n    <div class=\"form-item-core\">\n        <div class=\"form-item-left\">\n            \n                <p class=\"form-item-number\">".concat(itemIndex, " items</p>\n\n\n                <div class=\"lot-create-data__inputs-wrapper\">\n\n\n                    <div class=\"form-group lot-create-data__input--active\">\n                        <div class=\"lot-create-data__input-wrapper\">\n                            <label for=\"1").concat(id, "\">animal's type</label>\n                            <input form=\"add-lot-form\" id=\"1").concat(id, "\" type=\"text\" class=\"lot-create-data__input-price\" name=\"animal_type[").concat(itemIndex, "]\" list=\"item-animal-type\" placeholder=\"animal's type\">\n                            <datalist id=\"item-animal-type\">\n                                <option value=\"mammoth\">\n                                <option value=\"rhinoceros\">\n                                <option value=\"bison\">\n                            </datalist>\n                        </div>\n                    </div>\n\n\n                    <div class=\"form-group lot-create-data__input--active\">\n                        <div class=\"lot-create-data__input-wrapper\">\n                            <label for=\"4").concat(id, "\">item's type</label>\n                            <input form=\"add-lot-form\" id=\"4").concat(id, "\" type=\"text\" class=\"lot-create-data__input-price\" name=\"item_type[").concat(itemIndex, "]\" list=\"item-type\" placeholder=\"item's type\">\n                            <datalist id=\"item-type\">\n                                <option value=\"tusk\">\n                                <option value=\"tooth\">\n                                <option value=\"splint\">\n                                <option value=\"bark\">\n                                <option value=\"horn\">\n                                <option value=\"skull\">\n                                <option value=\"bone\">\n                            </datalist>\n                        </div>\n                    </div>\n\n\n                    <div class=\"form-group lot-create-data__input--active\">\n                        <div class=\"lot-create-data__input-wrapper\">\n                            <label for=\"item-11").concat(id, "\">item's grade</label>\n                            <input form=\"add-lot-form\" id=\"item-11").concat(id, "\" type=\"text\" class=\"lot-create-data__input-price\" name=\"item_grade[").concat(itemIndex, "]\" list=\"item-grade\" placeholder=\"item's grade\">\n                            <datalist id=\"item-grade\">\n                                <option value=\"4\">\n                                <option value=\"3\">\n                                <option value=\"2\">\n                                <option value=\"1\">\n                                <option value=\"0\">\n                            </datalist>\n                        </div>\n                    </div>\n                \n\n                    <div class=\"form-group lot-create-data__input--active\">\n                        <div class=\"lot-create-data__input-wrapper\">\n                            <label for=\"item-15").concat(id, "\">item's rarity</label>\n                            <input form=\"add-lot-form\" id=\"item-15").concat(id, "\" type=\"text\" class=\"lot-create-data__input-price\" name=\"item_rarity[").concat(itemIndex, "]\" list=\"item-rarity\" placeholder=\"item's rarity\">\n                            <datalist id=\"item-rarity\">\n                                <option value=\"typical\">\n                                <option value=\"rare\">\n                            </datalist>\n                        </div>\n                    </div>\n\n\n                    <div class=\"form-group lot-create-data__input--active\">\n                        <div class=\"lot-create-data__input-wrapper\">\n                            <label for=\"item-17").concat(id, "\">item's color</label>\n                            <input form=\"add-lot-form\" id=\"item-17").concat(id, "\" type=\"text\" class=\"lot-create-data__input-price\" name=\"item_color[").concat(itemIndex, "]\" list=\"item-color\" placeholder=\"item's color\">\n                            <datalist id=\"item-color\">\n                                <option value=\"natural\">\n                                <option value=\"blue\">\n                                <option value=\"brown\">\n                                <option value=\"grey\">\n                            </datalist>\n                        </div>\n                    </div>\n\n\n                    <div class=\"form-group lot-create-data__input--active\">\n                        <div class=\"lot-create-data__input-wrapper\">\n                            <label for=\"item-22").concat(id, "\">wet condition</label>\n                            <input form=\"add-lot-form\" id=\"item-22").concat(id, "\" type=\"text\" class=\"lot-create-data__input-price\" name=\"item_condition[").concat(itemIndex, "]\" list=\"item-condition\" placeholder=\"item's condition\">\n                            <datalist id=\"item-condition\">\n                                <option value=\"dry\">\n                                <option value=\"wet\">\n                                <option value=\"25% wet\">\n                                <option value=\"50% wet\">\n                                <option value=\"75% wet\">\n                                <option value=\"100% wet\">\n                            </datalist>\n                        </div>\n                    </div>\n\n                    <div class=\"form-group lot-create-data__input--active\">\n                        <div class=\"lot-create-data__input-wrapper\">\n                            <label for=\"item-25").concat(id, "\">item weight</label>\n                            <input form=\"add-lot-form\" id=\"item-25").concat(id, "\" type=\"number\" class=\"lot-create-data__input-weight\" name=\"item_weight[").concat(itemIndex, "]\" value=\"10\" placeholder=\"10\">\n                        </div>\n                    </div>\n\n                    <input form=\"add-lot-form\" id=\"item-500\" type=\"hidden\" name=\"lot_id[").concat(itemIndex, "]\">\n\n                </div>\n            \n            </div>\n\n        <div class=\"form-item-right\">\n            <div class=\"form-item-delete\">\n                <p class=\"form-item-delete-title\">delete</p>\n            </div>              \n        </div>\n\n    </div>\n    ");
  };

  var fillHtmlList = function fillHtmlList() {
...
__webpack_require__(/*! ./services */ "./resources/js/services.js");

__webpack_require__(/*! ./saleStatus */ "./resources/js/saleStatus.js");
...
__webpack_require__(/*! ./input */ "./resources/js/input.js");

__webpack_require__(/*! ./admin-create-lot/createLot */ "./resources/js/admin-create-lot/createLot.js");

__webpack_require__(/*! ./admin-create-lot/createLot-setLotSizeTitle */ "./resources/js/admin-create-lot/createLot-setLotSizeTitle.js");

__webpack_require__(/*! ./admin-create-lot/createLot-weightCounter */ "./resources/js/admin-create-lot/createLot-weightCounter.js");

__webpack_require__(/*! ./databaseItemOpener */ "./resources/js/databaseItemOpener.js");

__webpack_require__(/*! ./hideHomeBreadcrumb */ "./resources/js/hideHomeBreadcrumb.js");

__webpack_require__(/*! ./fslightbox */ "./resources/js/fslightbox.js");

__webpack_require__(/*! ./filter */ "./resources/js/filter.js");

__webpack_require__(/*! ./range-slider */ "./resources/js/range-slider.js");

__webpack_require__(/*! ./fastPageLinks */ "./resources/js/fastPageLinks.js");
...
/***/ "./resources/js/databaseItemOpener.js":
/*!********************************************!*\
  !*** ./resources/js/databaseItemOpener.js ***!
  \********************************************/
/***/ (() => {
...
if (document.querySelector('.databaseItem-content-itemWrapper')) {
  var items = document.querySelectorAll('.databaseItem-content-itemWrapper');
  var icon = document.querySelector('.expander__icon--item');
  items.forEach(function (element) {
    element.addEventListener('click', function (event) {
      var target = event.currentTarget;
      var itemMore = target.querySelector('.databaseItem__content-item-more');
      var expander__icon = target.querySelector('.expander__icon--item');
      var title = target.querySelector('.databaseItem__content-item-title');
...
/***/ "./resources/js/fastPageLinks.js":
/*!***************************************!*\
  !*** ./resources/js/fastPageLinks.js ***!
  \***************************************/
/***/ (() => {

var links = document.querySelectorAll('.scroll_link');
...
if (document.querySelector('.database-filter__wrapper')) {
  var filter = document.querySelector('.database-filter__wrapper');
  var filterCloseBtn = document.querySelector('.database-filter__close');
  var filtersData = document.querySelectorAll('.database-filter__data');
  filter.addEventListener('click', function (event) {
    var filter = event.currentTarget;
    var filterData = filter.querySelectorAll('.database-filter__options-data');
    ...
    filtersData.forEach(function (el) {
...
if (document.querySelector('.databaseItem-image-section')) {
  var databaseItem_gallery = document.querySelector('.databaseItem-gallery');
  databaseItem_gallery.addEventListener('click', function (event) {
    var newLightbox = new FsLightbox();
    var currentPhoto = document.querySelector('.databaseItem-images-wrapper-active').children[0].getAttribute('src');
    var firstPath = currentPhoto.replace('micro_images', 'large_images');
    var databaseItems = document.querySelectorAll('.databaseItem-images-wrapper');
    var arrPath = [firstPath];
    var arrPath2 = [];
    databaseItems.forEach(function (element) {
      var paths = element.children[0].getAttribute('src');
      var path2 = paths.replace('micro_images', 'large_images');
      arrPath2.push(path2);
    });
    arrPath.push.apply(arrPath, arrPath2);

    var arrPath_unique = _toConsumableArray(new Set(arrPath));

    newLightbox.props.sources = arrPath_unique;
    refreshFsLightbox();
    newLightbox.open();
  });
}
...
/***/ "./resources/js/hideHomeBreadcrumb.js":
/*!********************************************!*\
  !*** ./resources/js/hideHomeBreadcrumb.js ***!
  \********************************************/
/***/ (() => {
...
Array.prototype.forEach.call(fields, function (input) {
  ...
  input.addEventListener('change', function (e) {
    ...
    if (countFiles) label.querySelector('.field__file-fake').innerText = 'added files: ' + countFiles;else label.querySelector('.field__file-fake').innerText = labelVal;
  });
});
...
!function (e) {
  "function" == typeof define && __webpack_require__.amdO ? define([], e) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = e() : window.wNumb = e();
}(function () {
  "use strict";
  ...
  function r(e, n, t) {
    if ((e[n] || e[t]) && e[n] === e[t]) throw new Error(n);
  }
  ...
  function f(n, t, r, f, u, a, c, s, d, p, l, h) {
    var g,
        v,
        w,
        m = h,
        x = "",
        y = "";
    return a && (h = a(h)), i(h) ? (n !== !1 && 0 === parseFloat(h.toFixed(n)) && (h = 0), 0 > h && (g = !0, h = Math.abs(h)), n !== !1 && (h = o(h, n)), h = h.toString(), -1 !== h.indexOf(".") ? (v = h.split("."), w = v[0], r && (x = r + v[1])) : w = h, t && (w = e(w).match(/.{1,3}/g), w = e(w.join(e(t)))), g && s && (y += s), f && (y += f), g && d && (y += d), y += w, y += x, u && (y += u), p && (y = p(y, m)), y) : !1;
  }

  function u(e, r, o, f, u, a, c, s, d, p, l, h) {
    var g,
        v = "";
    return l && (h = l(h)), h && "string" == typeof h ? (s && n(h, s) && (h = h.replace(s, ""), g = !0), f && n(h, f) && (h = h.replace(f, "")), d && n(h, d) && (h = h.replace(d, ""), g = !0), u && t(h, u) && (h = h.slice(0, -1 * u.length)), r && (h = h.split(r).join("")), o && (h = h.replace(o, ".")), g && (v += "-"), v += h, v = v.replace(/[^0-9\.\-.]/g, ""), "" === v ? !1 : (v = Number(v), c && (v = c(v)), i(v) ? v : !1)) : !1;
  }
  ...
  function a(e) {
    ...
    for (n = 0; n < d.length; n += 1) {
      if (t = d[n], i = e[t], void 0 === i) "negative" !== t || o.negativeBefore ? "mark" === t && "." !== o.thousand ? o[t] = "." : o[t] = !1 : o[t] = "-";else if ("decimals" === t) {
        if (!(i >= 0 && 8 > i)) throw new Error(t);
        o[t] = i;
      } else if ("encoder" === t || "decoder" === t || "edit" === t || "undo" === t) {
        if ("function" != typeof i) throw new Error(t);
        o[t] = i;
      } else {
        if ("string" != typeof i) throw new Error(t);
        o[t] = i;
      }
    }
  ...
  function c(e, n, t) {
    ...
    return i.push(t), n.apply("", i);
  }

  function s(e) {
    return this instanceof s ? void ("object" == _typeof(e) && (e = a(e), this.to = function (n) {
      return c(e, f, n);
...
var rangeSliderWidth = document.getElementById('range-slider__weight');
var rangeSliderPrice = document.getElementById('range-slider__price');

if (rangeSliderWidth) {
  nouislider__WEBPACK_IMPORTED_MODULE_0___default().create(rangeSliderWidth, {
    range: {
      'min': 0,
      'max': 200
    },
...
if (rangeSliderPrice) {
  nouislider__WEBPACK_IMPORTED_MODULE_0___default().create(rangeSliderPrice, {
    range: {
      'min': 0,
      'max': 25000
    },
  ...
  var _input = document.getElementById('input-price-1');

  var input2 = document.getElementById('input-price-2');
  var _inputs = [_input, input2];
  ...
  _inputs.forEach(function (element, index) {
    element.addEventListener('change', function (event) {
      _setRangeSlider(index, event.currentTarget.value);
    });
  });
...
if (document.querySelector('.databaseItem-span-status')) {
  var status = document.querySelector('.databaseItem-span-status');
...
var expanders = document.querySelectorAll('.services__expander');
expanders.forEach(function (element) {
  element.addEventListener('click', function (e) {
    var item = e.currentTarget.parentElement.parentElement.querySelector('.services__item-description-list-wrapper');
    item.classList.toggle("services__item-description-list-wrapper--active");
    var curentExpander = e.currentTarget.querySelector('.expander__icon');
    var curentServiceItem = e.currentTarget.closest('.services__item');
...
if (document.querySelector('.database__item-status')) {
  var status = document.querySelectorAll('.database__item-content-status > span');
  status.forEach(function (element) {
    var statusIcon = element.parentElement.parentElement.parentElement.parentElement.parentElement.querySelector('.database__item-status');
