        ...
        <section class="dashboard-create__control-panel">
            ...
            <div class="dashboard-create__form-data">
                    <div class="form-group lot-create-data__input-wrapper--image">                     
                        ...
                        <!-- категория товара -->
                        <input form="add-product" type="hidden" name="product_category" value="композит">   
                        <!-- Артикул товара -->
                        ...
                        <div class="form-group lot-create-data__input-wrapper">
                            ...
                            <datalist id="name">
                                <option value="алюм волна">
                                <option value="нобл волна">
                                <option value="нобл волна sfx">
                        ...
                        <div class="form-group lot-create-data__input-wrapper">
                            ...
                            <datalist id="color">
                                ...
                                <option value="бронза">
                                <option value="латунь">
                                <option value="жёлтая латунь">
                                <option value="медь">
                                <option value="бронза и латунь">
                                <option value="чёрный уран">
                                <option value="синий уран">
                            </datalist>
                        </div>
                        <!-- статус товара --> 
                        <div class="form-group lot-create-data__input-wrapper">
                    ...
                    <div class="dashboard-create__product-parameters-wrapper-outer">           
                        ...
                        <div class="dashboard-create__product-parameters-wrapper-inner">
                            <div class="form-group lot-create-data__input-wrapper dashboard-create__input-wrapper--parameters">
                                ...
                                <input form="add-product" type="number" class="product-input dashboard-create__product-input" name="product_length" placeholder="Длина" value="120">          
                            </div>
                            <div class="form-group lot-create-data__input-wrapper dashboard-create__input-wrapper--parameters">
