...
__webpack_require__(/*! ./selectSaver */ "./resources/js/selectSaver.js");

__webpack_require__(/*! ./fslightbox */ "./resources/js/fslightbox.js");

__webpack_require__(/*! ./mobile-menu */ "./resources/js/mobile-menu.js"); // минин
...
//     let databaseItem_gallery = document.querySelector('.databaseItem-gallery');
//     databaseItem_gallery.addEventListener('click', event => {
//         const newLightbox = new FsLightbox();
//         let currentPhoto = document.querySelector('.databaseItem-images-wrapper-active').children[0].getAttribute('src');
//         let firstPath = currentPhoto.replace('micro_images', 'large_images')
//         let databaseItems = document.querySelectorAll('.databaseItem-images-wrapper');
//         let arrPath = [firstPath];
//         let arrPath2 = [];
//         databaseItems.forEach((element) => {
//             let paths = element.children[0].getAttribute('src');
//             let path2 = paths.replace('micro_images', 'large_images');
//             arrPath2.push(path2);
//         });
//         arrPath.push.apply(arrPath, arrPath2);
//         let arrPath_unique = [...new Set(arrPath)];
...
function ready() {
  ...
  burgerBtn.addEventListener('click', function () {
    ...
    var burger_span = document.querySelector('.header__burger-span');
    var burger_span_1 = document.querySelector('.header__burger-span-1');
    var burger_span_2 = document.querySelector('.header__burger-span-2');
