                        ...
                        @foreach($products as $product)
                            ...
                            <li class="cart__product-item">
                                ...
                                <div class="cart__product-quantity-wrapper">
                                    ...
                                    @livewire('cart.item-plus', ['product_id' => $product->id])
                                    <form wire:submit="plus({{$product_id}})">
                                        <button type="submit" class="cart__product-quantity-button cart__product-quantity-button--plus">&#43;</button>
                                    </form>
                                    <button wire:click="plus({{$product_id}})" type="submit" class="cart__product-quantity-button cart__product-quantity-button--plus">&#43;</button>
                                    ...
                                    <p wire:model="itemQuantity" class="cart__product-quntity">{{ $itemQuantity }}</p>

                                    
                                </div>

                                @livewire('cart.item-cost')
